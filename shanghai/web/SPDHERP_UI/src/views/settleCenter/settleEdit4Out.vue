<template>
    <el-row id="settle-edit" v-loading="diaLoging">
        ...
        <el-table ref="receListTable" :data="settleBill.lstDetail" style="width: 100%;" fit height="380" stripe border>
            ...
            <el-table-column label="出库单号" prop="outBillid" width="140">
            </el-table-column>
            ...
            <el-table-column label="产地" prop="made" width="50">
            </el-table-column>
...
export default {
    ...
    methods: {
            ...
            this.axios.post(serviceUrl, this.settleBill).then(res => {
                ...
                if (res.data.code == "0") {
                    ...
                    _this.$msgbox({
                        ...
                        type: "success",
                        callback: action => {
                            this.$router.push({ path: 'settleBill4Out', query: { billId: billId } });
                        }
                    });
        ...
        cancel() {
            this.$router.push({ path: 'settleBill4Out' });
             //this.$router.go(-1);
        },
        getOutBillDetail() {
    ...
    mounted() {
        ...
        if (settleBillId) {
            ...
            this.opModel = "ADD";
            this.settleBill = this.getSettleBill4Out;
        }
    }
};
