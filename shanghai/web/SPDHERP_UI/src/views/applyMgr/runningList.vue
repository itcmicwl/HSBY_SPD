                              ...
                              <el-table-column prop="sourceWarehouseName" label="目标科室" sortable> </el-table-column>
                                ...
                                <el-table-column label="操作" width="150">
                                    <template slot-scope="scope">
                                        ...
                                        <el-button v-if="scope.row.state == 10"  @click="editBill(scope.row)" type="text">编辑</el-button>
                            ...
                            <template>
                                    <el-row  height="auto"    style="height:100%;padding-top:0px">     
                                        <el-col :span="6" class="toolbar" style="padding-bottom: 0px; padding-left:5px; height: calc(100% - 30px);">
                                            <el-table highlight-current-row class="runSur-tableheight"
...
#running-list .el-dialog__body{
       height:  calc(100% - 150px);
       
       padding-bottom: 0px;

}
#running-list .el-dialog--center{
       height:  calc(100% - 0px);
       margin-top: 0px;
}
#running-list .el-dialog__wrapper{
       height:  calc(90% - 0px);
}
