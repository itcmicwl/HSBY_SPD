<template>
  <el-dialog title="退至供应商" :visible.sync="vEditer" width="80%">
...
export default {
    ...
    methods: {
        ...
        submitPurconfirm(status) {
            ...
            var serviceUrl = this.opModel=="ADD"? '/spdHERPService/stockMgr/inStock/addSup' : '/spdHERPService/stockMgr/inStock/update';
            var _this = this;
